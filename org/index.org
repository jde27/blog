...
[[./horikawa-surfaces.org][Read on for more...]]
...
[[./blogroll.org][blogroll]]. Below the line, I include the shell script which I used to
generate the RSS feed for the blog.

[[./new-functionality.org][Read on for more.]]
...
[[./farmageddon.org][Read on for more.]]
...
Barth-Peters-Van de Ven around with me, here is a blog post containing
...
[[./surfaces-crib-sheet.org][Read on for more.]]

* Clarification for arXiv:1606.08656 			    :geometry:errata:

[2018-01-31 Wed]

[[http://arxiv.org/abs/1606.08656][The paper Ivan Smith and I wrote on Lagrangian pinwheels in
...
anyone else has the same questions, I thought I would write a blog
post clarifying these points.

[[./clarification-160608656.org][Read on for more]].
...
[[./clarifications-errata.org][Read on for more.]]
...
[[./heisenberg.org][Read on for more.]]
...
one point of view (the Schr\ouml{}dinger picture) on the answer to
this question which I find satisfying.

[[./what-is-qft.org][Read on for more.]]
...
[[https://www.homepages.ucl.ac.uk/~ucaheps][Ed Segal]] and I are planning to run a QFT reading group at UCL to
...
[[./equivalence-relation.org][Read on for more.]]

* Theorem and proof environments in CSS 			   :blog:org:

[2017-09-12 Tue]

Here is a nice idea from [[http://drz.ac/2013/01/17/latex-theorem-like-environments-for-the-web/][Dr Z.ac]], the blog of Zachary Harmany. You can
use CSS to create LaTeX-style theorem/proof environments on a website.

[[./thm-and-proof.org][Read on for more.]]
...
[[./resonances.org][Read on for more.]]

* Nice paper bump 							:qft:

[2016-08-31 Wed]

It's 7 years old, but I only just came across the following beautiful
expository paper of Baez and Huerta on the representation theory
underlying the standard model and grand unified theories and I thought
I would give it a bump:

[[https://arxiv.org/abs/0904.1556]]

It overlaps with some of the material I touch on in the Lie Groups
course I teach (using representations to classify particles) but goes
into much more gorgeous detail and focuses on fundamental particles
rather than baryons/mesons. It is unusually easy to follow (if you
know a bit of representation theory) and I learned a lot from reading
it.
...
I recently came across [[https://en.wikisource.org/wiki/A_proof_of_the_constancy_of_the_velocity_of_light][ a beautiful argument due to De Sitter (1913)]],
...
[[./lightspeed.org][Read on for more.]]
...
trawling through a bunch of PDFs, so I made [[http://www.homepages.ucl.ac.uk/~ucahjde/pathways.htm][this webpage]] to illustrate
...
To generate the image maps I used a fantastic programme called
graphviz. In case anyone wants to adapt what I did to their own ends,
I have made my graphviz code for these diagrams (plus some ancillary
shells scripts for creating and uploading the webpage) available [[http://www.homepages.ucl.ac.uk/~ucahjde/choices/pathways.zip][here:]]

For more details, see the [[http://www.homepages.ucl.ac.uk/~ucahjde/choices/readme.txt][readme file]].
...
into a [[../spectralseq.pdf][sequence of guided exercises]]. This is all very formal and
...
[[./sanitycheck.org][Read on to test your sanity.]]
...
[[./gromoll-filtration.org][Read more.]]
...
students" is now [[http://www.homepages.ucl.ac.uk/~ucahjde/video-report.pdf][available to download in PDF form]].
...
[[./video-project-update.org][Read on for some of the results]]
...
[[./geometry-and-undecidability.org][Read the rest of this entry]].
...
and [[http://youtu.be/44pDNRMW2xM][here]].

[[./video-project-weeks-1-2.org][Read on for a summary of the early teething problems we have
...
project for filming maths lectures. [[./eldg.org][Read on for more about the
project]].
...
[[./e-learning-spring-2013.org][Read on for more]].
...
[[./bored-now.org][Read on for more]].
...
[[./johnson-homomorphism.org][Read on for more]].
...
#+HEADER: :file ../img/octa.svg :imagemagick yes
...
[[./convex-integration-talk-notes.org][Read on for more]].
...
[[./convex-integration-cartoon.org][Read on for more]].
...
[[./kronheimer-argument.org][...here's an explanation to which I can point people in future]].
...
[[./symplectic-contact-7-day-1.org][Read on for more...]]
...
[[./ucl-gt-open-day-talk-floer.org][Read on for more...]]
...
[[./why-schrodinger.org][Read on to find out more...]]
...
[[./hea-course.org][Read on for a couple of ideas I took away (not necessarily
maths-specific!).]]
...
[[./lines-through-four-lines.org][Read on for more...]]
...
searching a database. [[http://en.wikipedia.org/wiki/Grover’s_algorithm][Wikipedia]] has a really nice exposition too, but
...
in N); Grover's algorithm has a surprising runtime of order $\sqrt{N}$
to do the same thing, using clever ideas from quantum mechanics.

[[./grover.org][Read on to find out more...]]
